...
| $AA , aa$ ($p^2q^2$)| $\color{green}{\{Aa, Aa\}}$ (1) | $\color{green}{\frac{(q-p)^2}{2pq}}$ |$\color{green}{\frac{1}{4}}$ | $\color{green}{\frac{1}{2}}$ | $\color{green}{\frac{1}{4}}$ | $\color{green}{\frac{1}{2}}$ |
...
$E(IBD)=\begin{matrix}
p^4&\\
+(\frac{3}{2}\frac{1}{4}+\frac{1}{2}\frac{1}{2}+\frac{3}{2}\frac{1}{4})4p^3q&\\
+p^2q^2&\\
+(1\frac{1}{16}+\frac{1}{2}\frac{1}{4}+0\cdot \frac{1}{8}+\frac{1}{2}\frac{1}{4}+\frac{1}{2}\frac{1}{4}+1\cdot \frac{1}{16})4p^2q^2&\\
...
The variance is
$var(IBD)=\begin{matrix}
(0-\frac{1}{2})^2 4p^2q^2 & \\
+(\frac{1}{4}-\frac{1}{2})^2  2p^3q & \\
+(\frac{3}{4}-\frac{1}{2})^2 (2p^3q+2pq^3) & \\
(1-\frac{1}{2})^2 (\frac{p^2q^2}{2}+2p^2q^2)
\end{matrix} 
=\frac{9}{8}p^2q^2+\frac{1}{4}p^3q+\frac{5}{8}pq^3$
