...
The <font color="navy">`EigenGWAS`</font> model resembles the Newtown's first and the second [laws for classical mechanics](https://en.wikipedia.org/wiki/Newton%27s_laws_of_motion). The first law states that 
