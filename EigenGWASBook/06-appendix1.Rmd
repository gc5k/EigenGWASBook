...
$\hat{F}_{st}^{WC}=1-\frac{2\frac{n_1n_2}{n_1+n_2}\frac{1}{n_1+n_2}[n_1\tilde{p}_1(1-\tilde{p}_1)+n_2\tilde{p}_2(1-\tilde{p}_2))]}{\frac{n_1n_2}{n_1+n_2}(\tilde{p_1}+\tilde{p_2})^2+(2\frac{n_1n_2}{n_1+n_2}-1)\frac{1}{n_1+n_2-2}[n_1\tilde{p}_1(1-\tilde{p}_1)+n_2\tilde{p}_2(1-\tilde{p}_2)]}$
...
$\hat{F}_{st}^{Nei}=\frac{\tilde{p}_1+\tilde{p}_2}{2\tilde{p}(1-\tilde{p})}$
...
$F_{st}^{Hudson} = \frac{(\tilde{p}_1-\tilde{p}_2)^2-\frac{\tilde{p}_1(1-\tilde{p}_1)}{n_1-1}-\frac{\tilde{p}_2(1-\tilde{p}_2)}{n_2-1}}{\tilde{p}_1(1-\tilde{p}_1)+\tilde{p}_2(1-\tilde{p}_2)}$
